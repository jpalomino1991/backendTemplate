...
{
    public class ModifyPermissionTypeHandler : ICommandHandler<PermissionTypeDTO>
    {
        private readonly IUnitOfWork _unitOfWork;
        public ModifyPermissionTypeHandler(IUnitOfWork unitOfWork)
        {
        ...
        public void Handle(PermissionTypeDTO command)
        {
            ...
            _unitOfWork.PermissionTypeRepository.UpdatePermissionType(_permissiontype);
        }
    }
}
